        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Mari membeli ternak sekarang dan percayakan pada kami.
              Disini kamu akan menemukan pelayanan yang ramah dan amanah sesuai dengan kebutuhanmu dan
              Dapatkan update ternakmu secara realtime.
            </p>
